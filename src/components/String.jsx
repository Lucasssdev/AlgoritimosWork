...
function String({setMenu, handleOnFile, file, string,searchString, handleOnString}) {
    ...
    return (
      <div className='flex h-screen w-screen flex-col p-0  m-0 bg-[#d3f9aa]'>
          <button onClick={()=> {setMenu(0)}} className='flex hover:text-[#575757] w-10  justify-start ml-7 mt-3'>
          ...
          <div className='flex h-auto flex-col gap-4 p-0 mt-16 justify-center items-center '>
              ...
              <div className='bg-[#a4ce55] shadow-3xl  w-[350px] px-10 py-3 justify-center items-center flex flex-col rounded-xl '>
                  <h1 className="flex pb-3 font-semibold text-lg">
                      Selecione um arquivo
                  </h1>
                  <label htmlFor="file" className=" flex w-28 font-bold justify-center rounded-md p-1 border-2 shadow-3xl hover:shadow-lg  hover:bg-[#e7fdbe] bg-[#f6ffe4]">
                      Selecionar
                  </label>
          ...
          <div className='flex h-auto flex-col gap-4 justify-center items-center '>
              <div className='bg-[#a4ce55] shadow-3xl  w-[350px] p-10 justify-center flex flex-col rounded-xl mt-10'>
              ...
              <button onClick={searchString} className='px-32 py-3 font-black rounded-xl shadow-3xl hover:shadow-lg bg-[#f6ffe4] hover:bg-[#bee37b] hover:text-lg'>
                  Procurar
              </button>
          </div>
      </div>
